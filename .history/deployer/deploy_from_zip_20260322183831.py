...
def print_summary(
    ...
    print("1. Flusso GitHub Pages: copieremo docs/ in un repo locale e faremo git add/commit/push.")
    print("2. Flusso GAS/clasp: useremo codice.gs e appsscript.json per push e deploy del backend.")
